...
function Configuration(){
  var configUrl = "http://api.aniways.com/v2/configuration", _userConfiguration = {};
  ...
  var defaultConfiguration = {
    ...
    assetsUrl: "https://aniways.blob.core.windows.net/aniways-assets/120/"
  };
  ...
  /* test-code */
  this._defaultConfig = defaultConfiguration;
  /* end-test-code */
}
...
function Decoder(phraseMapping, configuration){
  ...
  function unicodeDecoding(message){
    ...
    for (var i=0; i<messageEncodingData.data.length; i++ ) {
      ...
      if(encodingData.imageId === VIRAL_LINK_ID){
      ...
      if(imagePath === undefined){
        ...
        html += "<img class='aniways-wall-image' style=height:" +
          configuration.wallImageSize() + "px; src='" + imagePath + "'>";
  ...
  /* test-code */
  this._unicodeToDecimal = unicodeToDecimal;
  this._extractUnicodeEncodingData = extractUnicodeEncodingData;
  this._extractUrlEncodingData = extractUrlEncodingData;
  /* end-test-code */
  ...
  function handleNode(node){
    if(typeof node.getElementsByClassName === 'function'){
      ...
      if(message.length > 0){
        ...
        var indexOfPlaceMessage = decodedMessage.indexOf("<br><br>To view places");
        if (indexOfPlaceMessage != -1){
          decodedMessage = decodedMessage.substring(0, decodedMessage.indexOf("<br><br>To view places"));
        }
